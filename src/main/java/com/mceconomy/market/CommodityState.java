...
public final class CommodityState {
	...
	public CommodityState(Commodity commodity, double price, double basePrice, double supplyIndex, double demandIndex) {
	...
	public static CommodityState createDefault(Commodity commodity) {
		return new CommodityState(commodity, commodity.basePrice(), commodity.basePrice(), 0, 0);
	}
